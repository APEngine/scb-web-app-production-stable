...
from .views import (
    ...
    get_filtered_current_tasks_information,
    #
...
urlpatterns = [
    ...
    path(
        "tasks/information-and-related/current-tasks-information/<str:user_id>/<str:project_id>",
        get_filtered_current_tasks_information,
        name="filtered_current_tasks_information"
    ),
