...
class ClientForm(forms.Form):
    clientCode = forms.IntegerField(required=True)
    clientName = forms.CharField(required=True, 
                                 max_length=100, 
                                 validators=[
                                     MinLengthValidator(5), MaxLengthValidator(100)
                                ])
    clientDirection =  forms.CharField(required=True, 
                                 max_length=200, 
                                 validators=[
                                     MinLengthValidator(5), MaxLengthValidator(200)
                                ])  
    clientEmail = forms.CharField(required=True, 
                                 max_length=150, 
                                 validators=[
                                     MinLengthValidator(5), MaxLengthValidator(150)
                                ])
    clientPhoneContact = forms.CharField(required=True, 
                                 max_length=60, 
                                 validators=[
                                     MinLengthValidator(5), MaxLengthValidator(60)
                                ])
    clientWebPage = forms.CharField(required=True, 
                                 max_length=200, 
                                 validators=[
                                     MinLengthValidator(5), MaxLengthValidator(200)
                                ])
