...
class Tareas(models.Model):
    ...
    nombre = models.CharField(db_column='Nombre', max_length=100)  # Field name made lowercase.
    descripcion = models.CharField(db_column='Descripcion', max_length=250, blank=False, null=False)  # Field name made lowercase.
...
class Tipousuarios(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'admin_management_tipousuarios'
...
class Usuarios(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'admin_management_usuarios'
